...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  {
    $username_err = "Please enter a title for your survey.";
  }
  else
  {
    $username = mysqli_real_escape_string($db, $_POST['survey_title']);
  }
  ...
  if(!empty($username) && !empty($surveyID) && !empty($surveyURL))
  {
    $query = "INSERT INTO surveys (username, surveyID, survey_url, survey_title, survey_desc) VALUES ('$username', '$surveyID', '$survey_url', '$survey_title', '$survey_desc')";
        ...
        <div class="createsurvey-page">
          ...
          <fieldset class="create">
            ...
            <div class="form-group">
              ...
              <br>
              <textarea class="textbox" maxlength="300" rows="10" cols="50" placeholder="(Optional) Enter survey description."></textarea>
              <br>
            </div>
